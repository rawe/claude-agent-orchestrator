# Releasing @rawe/context-store-sdk
...
- [ ] Tests pass: `npm test -w @rawe/context-store-sdk`
...
```bash
# Check npm registry
npm view @rawe/context-store-sdk
...
```bash
npm unpublish @rawe/context-store-sdk@0.1.0
```

## Deprecate a Version

```bash
npm deprecate @rawe/context-store-sdk@0.1.0 "Use 0.2.0 instead"
```
