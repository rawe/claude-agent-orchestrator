#!/bin/bash
# =============================================================================
# Start Agent Runner for Claude SDK Executor - Development Mode
# =============================================================================
# - Executor: Claude SDK Executor (autonomous profile, uses Claude Agent SDK)
...
"$PROJECT_ROOT/servers/agent-runner/agent-runner" --profile claude-sdk-executor
