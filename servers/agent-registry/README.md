...
Agent blueprints (system prompts, MCP servers, skills) are stored as files. This service provides a unified API that both the **CLI commands** (`ao-list-agents`, `ao-new --agent`) and the **Dashboard** use to manage agents. Single source of truth, no direct file manipulation needed.
